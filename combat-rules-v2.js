...
function flatStrengthen(source,classes){return statusActive(source,'strengthen').filter(s=>intersects(s.classes||['all'],classes)&&(!s.stat||s.stat==='attack')&&modifierMode(s)!=='percent').reduce((n,s)=>n+Math.max(0,num(s.amount,s.value)),0)}
